...
function demo(; verbose = false)
    ...
    function generate_samples()
        ...
        for i in [34, 46, 48, 52, 55, 61, 65, 73, 82, 94]
            ...
            initial_y_pos2 = selected_problem["initial_state2"][2]
            initial_y_pos3 = selected_problem["initial_state3"][2]

            for j in 1:11
                initial_state1 = [-0.3, initial_y_pos1 + rand(-1:0.0001:1)*ϵ, initial_x_vel1 + rand()*ϵ, 0.0]
                initial_state2 = [0.1, initial_y_pos2 + rand(-1:0.0001:1)*ϵ, 0.2, 0.0]
                initial_state3 = [0.4, initial_y_pos3 + rand(-1:0.0001:1)*ϵ, 0.2, 0.0]
